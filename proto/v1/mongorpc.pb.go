...
type Sample struct {
	...
	Code    *timestamp.Timestamp `protobuf:"bytes,3,opt,name=code,proto3" json:"code,omitempty"`
}
...
func (x *Sample) GetDetails() []*any.Any {
	if x != nil {
		return x.Details
	}
	return nil
...
func (x *Sample) GetCode() *timestamp.Timestamp {
	if x != nil {
		return x.Code
	}
	return nil
...
var file_mongorpc_proto_rawDesc = []byte{
	...
	0x82, 0x01, 0x0a, 0x06, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65,
	...
	0x61, 0x69, 0x6c, 0x73, 0x12, 0x2e, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x04,
	0x63, 0x6f, 0x64, 0x65, 0x42, 0x32, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x6f, 0x6e, 0x67,
	0x6f, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x76, 0x31, 0x42, 0x0d, 0x4d,
	0x6f, 0x6e, 0x67, 0x6f, 0x72, 0x70, 0x63, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x08,
...
var file_mongorpc_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mongorpc_proto_goTypes = []interface{}{
	(*Sample)(nil),              // 0: mongorpc.proto.v1.Sample
	(*any.Any)(nil),             // 1: google.protobuf.Any
	(*timestamp.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_mongorpc_proto_depIdxs = []int32{
	1, // 0: mongorpc.proto.v1.Sample.details:type_name -> google.protobuf.Any
	2, // 1: mongorpc.proto.v1.Sample.code:type_name -> google.protobuf.Timestamp
